			...
			<scroll-view scroll-y="true" >
				...
				<view class="detail-lyric">
					<view class="detail-lyric-wrap" :style="{ transform : 'translateY(' + -(lyricIndex - 1)*82 + 'rpx)'}">
						...
						<!-- <view class="detail-lyric-item active">测试文字测试文字测试文字测试文字</view>
				...
				<view class="detail-like">
					...
					<view class="detail-like-item" v-for="(item,index) in songSimi" :key="index" @tap="handleToDetail(item.id)">
						...
						<view class="detail-like-song">
							<view class="">{{item.anme}}</view>
							<view class="">
								<image src="../../static/list/MV.png" mode=""></image>
...
.detail-play {
	width: 500rpx;
	height: 500rpx;
	background: url(~@/static/info/disc.png);
...
.detail-play view {
	width: 240rpx;
	height: 360rpx;
	background: url(../../static/info/needle.png);
	position: absolute;
	left: 100rpx;
	right: 0;
	top: -200rpx;
